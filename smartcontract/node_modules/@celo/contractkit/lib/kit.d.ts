...
import { CeloTokenContract } from './base';
 ...
 */
export declare function newKit(url: string, wallet?: ReadOnlyWallet): ContractKit;
/**
...
export declare class ContractKit {
    ...
    getHumanReadableNetworkConfig(): Promise<{
        exchanges: any;
        stableTokens: any;
        election: any;
        attestations: any;
