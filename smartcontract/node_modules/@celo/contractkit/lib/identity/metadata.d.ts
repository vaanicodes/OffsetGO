...
export declare class IdentityMetadataWrapper {
    ...
    static fetchFromURL(kit: ContractKit, url: string, tries?: number): Promise<IdentityMetadataWrapper>;
    ...
    static verifySignerForAddress(kit: ContractKit, hash: any, signature: any, address: Address): Promise<boolean>;
