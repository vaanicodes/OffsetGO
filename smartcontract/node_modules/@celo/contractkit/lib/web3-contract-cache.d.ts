...
export declare class Web3ContractCache {
    ...
    getExchange(stableToken?: StableToken): Promise<import("./generated/Exchange").Exchange | import("./generated/ExchangeEUR").ExchangeEur>;
    ...
    getStableToken(stableToken?: StableToken): Promise<import("./generated/StableToken").StableToken>;
