...
exports.stableTokenContractArray = [CeloContract.StableToken, CeloContract.StableTokenEUR];
...
exports.stripProxy = function (contract) { return contract.replace('Proxy', ''); };
exports.suffixProxy = function (contract) {
    return contract.endsWith('Proxy') ? contract : contract + "Proxy";
};
exports.ProxyContracts = exports.AllContracts.map(function (c) { return exports.suffixProxy(c); });
